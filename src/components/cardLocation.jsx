        ...
        <div>
            <div className="border border-solid	border-slate-400 max-w-sm mx-auto bg-transparent rounded overflow-hidden shadow-lg">                 
                  <div className="px-6 py-4 text-center">
                    ...
                    <p className="text-gray-700 text-base text-[#fff]"><b>Type:</b> {type}</p>
                    <p className="text-gray-700 text-base text-[#fff]"><b>Amount Residents:</b> {cantResidents}</p>
                    <p className="text-gray-700 text-base text-[#fff] h-10"><b>Dimension:</b> {dimension}</p>                    
                  </div>                  
            </div>
        </div>  
        </>
