        ...
        <div>
            <div className="border border-solid	border-slate-400 max-w-sm mx-auto bg-transparent rounded overflow-hidden shadow-lg">               
                  <div className="px-6 py-4 text-center">
                    ...
                    <p className="text-base text-[#fff]"><b>Episode:</b> {episode}</p>
                    <p className="text-base text-[#fff]"><b>Characters:</b> {cantCharacter}</p>
                    <p className="text-base text-[#fff]"><b>Air Date:</b> {air_date}</p>                    
                  </div>                  
            </div>
        </div>  
        </>
